...
const styles = StyleSheet.create({
  ...
  inningsScore: { color: C.text, fontSize: fontSize.lg, fontWeight: '800' },
  ...
  tableHeadCell: { color: C.muted, fontSize: fontSize.xs, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.3 },
  ...
  dismissalText: { color: C.muted, fontSize: fontSize.xs },
});

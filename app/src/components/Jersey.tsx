...
// parse.
// TEMP: restored (was deleted in ff53adb "Don't overlay team-code label on
// custom uploaded jersey designs") — disabled per request, show the label
// regardless of custom vs plain color-fill jersey for now.
...
export default function Jersey({
  ...
  if (jerseySvg) {
    // TEMP: re-enabled (was skipped in ff53adb "Don't overlay team-code
    // label on custom uploaded jersey designs") — disabled per request,
    // show the label regardless of custom vs plain color-fill jersey for now.
